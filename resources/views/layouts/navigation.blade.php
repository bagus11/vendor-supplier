<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img style="width:120px;height:45px;" src="{{URL::asset('logo.png')}}" alt="">     
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @php
                        ...
                        ->join('permissions', 'permissions.name','=','menuses.permission_name')
                    ...
                    @if($item->type==1)
                        <x-nav-link  href="{{$item->link}}" :active="request()->routeIs('{{$item->name}}')">
                            {{ __($item->name) }}
                        </x-nav-link>
                    @else
                    @php
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @endphp
          @foreach ($menus as $item)
          @if($item->type==1)
          <x-responsive-nav-link  href="{{$item->link}}" :active="request()->routeIs('{{$item->name}}')">
            {{ __($item->name) }}
