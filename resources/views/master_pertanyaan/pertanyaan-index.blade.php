...
<x-app-layout>
    ...
    {{-- list Pertanyaan --}}
        @include('master_pertanyaan.pertanyaan_list')
    {{-- End list Pertanyaan --}}
    {{-- Add Pertanyaan --}}
            @include('master_pertanyaan.add-pertanyaan_modal')
    {{--End Add Pertanyaan --}}
    {{-- Edit Pertanyaan --}}
            @include('master_pertanyaan.edit-pertanyaan_modal')
    {{--End Edit Pertanyaan --}}
  
</x-app-layout>
  {{-- Js --}}
    @include('master_pertanyaan.pertanyaan_js')
  {{-- End Js --}}